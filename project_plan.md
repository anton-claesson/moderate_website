...
| 2026-04-20 | F4.3 | UI refinements: CSS grid layout (1fr + 288px card column) replacing camera padding; thicker outlines (2px) with white hover/selection highlight line; auto-scroll list on map hover; accent hover style; opaque card; toggle flex-1 fix; fitBounds padding 60→20; dim layer (40% black) for surroundings in detail view. | — |
